...
-- DROP TYPE IF EXISTS public.acount_type;

CREATE TYPE public.acount_type AS ENUM
    ('Client', 'Employee', 'Admin');

ALTER TYPE public.acount_type
    OWNER TO cse340db;
...
-- Create the custom enum type if not exists
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'account_type') THEN
        CREATE TYPE account_type AS ENUM ('Client', 'Admin', 'Manager', 'Employee');
    END IF;
END
$$;
